...
void main() {
  group('LoadingService', () {
    test(
        'should create LoadingService with default values when no arguments are provided',
        () {
    ...
    test(
        'should change loading state when startLoading and stopLoading are called',
        () async {
      final loadingService = LoadingService();
